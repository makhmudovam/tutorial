...
def kril_lotin_konverter(text): 
    kril_alifbosi = "абвгдеёжзийклмнопрстуфхцчшщъыьэюя" 
    lotin_alifbosi = "abvgdeyozhziyklmnoprstufhtschshsh'y'yeuyya" 
    konvert = str.maketrans(kril_alifbosi, lotin_alifbosi) 
    return text.translate(konvert) 
 
kril_matn = input("Kril alifbosidagi matnni kiriting: ") 
lotin_matn = kril_lotin_konverter(kril_matn) 
print("Lotin alifbosidagi matn: ", lotin_matn)
